...
INSERT INTO BIBLIOTECA(ID_BIBLIOTECA, NOMBRE, DIRECCION, FECHA_FUNDACION, CIUDAD)
VALUES (2, 'FRANCHESCO POLINI', 'CRAJUE 350', '1994-04-10', 'CONSTINOPLA');
...
INSERT INTO BIBLIOTECARIO(ID_BIBLIOTECARIO, ID_BIBLIOTECA, APELLIDO, NOMBRE, FECHA_NACIMIENTO, FECHA_INICIO_ACTIVIDAD)
VALUES (4, 2, 'JUIREI', 'PABLO', '1985-05-30', '2020-04-20');
...
FROM BIBLIOTECA,
     BIBLIOTECARIO
WHERE BIBLIOTECARIO.ID_BIBLIOTECA = BIBLIOTECA.ID_BIBLIOTECA GROUP BY BIBLIOTECA.NOMBRE;
